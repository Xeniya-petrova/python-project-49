...
[![hexlet-check](https://github.com/Xeniya-petrova/python-project-49/actions/workflows/hexlet-check.yml/badge.svg)](https://github.com/Xeniya-petrova/python-project-49/actions)
...
```bash
git clone https://github.com/Xeniya-petrova/python-project-49.git
